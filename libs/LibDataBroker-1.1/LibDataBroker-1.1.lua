...
assert(LibStub:GetLibrary("CallbackHandler-1.0", true),
...
lib.callbacks = lib.callbacks or
                    LibStub:GetLibrary("CallbackHandler-1.0"):New(lib)
lib.attributestorage, lib.namestorage, lib.proxystorage =
    lib.attributestorage or {}, lib.namestorage or {}, lib.proxystorage or {}
local attributestorage, namestorage, callbacks = lib.attributestorage,
                                                 lib.namestorage, lib.callbacks
...
if oldminor < 3 then
    lib.domt.__newindex = function(self, key, value)
        ...
        callbacks:Fire("LibDataBroker_AttributeChanged_" .. name, name, key,
                       value, self)
        callbacks:Fire("LibDataBroker_AttributeChanged_" .. name .. "_" .. key,
                       name, key, value, self)
...
if oldminor < 4 then
    ...
    function lib:pairs(dataobject_or_name)
        ...
        local dataobj = self.proxystorage[dataobject_or_name] or
                            dataobject_or_name
